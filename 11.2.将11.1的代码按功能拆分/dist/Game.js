...
export class Game {
    constructor(CanvasDOM, Context2D, CANVAS_WIDTH, CANVAS_HEIGHT) {
    ...
    // 输入处理函数
    playerInputHandler(timeInterval) {
        // 默认情况 游戏场景一倍速度移动
    ...
    // 游戏场景移动处理函数
    scenceMoveHandler(timeInterval) {
    ...
    // 分数计算
    scoreUpdateHandler(timeInterval) {
