...
export class Animater {
    ...
    constructor(Context2D, CANVAS_WIDTH, CANVAS_HEIGHT, imgSrc, imgFrameWidth, imgFrameHeight, size, animateFramesTotal, animateNameIndexMap) {
        this.posX = 0; // 位置x
        this.posY = 0; // 位置y
    ...
    animate(timeInterval) {
        this.Context2D.drawImage(this.img, this.animateFrameIndexX * this.imgFrameWidth, this.animateFrameIndexY * this.imgFrameHeight, this.imgFrameWidth, this.imgFrameHeight, this.posX, this.posY, this.drawWidth, this.drawHeight);
    }
    // 刷新
