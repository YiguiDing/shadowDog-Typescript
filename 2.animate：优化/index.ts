...
var selector = document.querySelector("#animations") as HTMLSelectElement;
...
let animaIndex = 0;// 动画索引
let frameIndex = 0;// 帧索引
let frameCount = 0;// 总的帧数
let stageFrame = 5;// 交错帧，每隔5帧 切换关键帧
